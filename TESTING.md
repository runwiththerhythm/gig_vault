...
| gigs | [gig_list.html](https://github.com/runwiththerhythm/gig_vault/blob/main/gigs/templates/gigs/gig_list.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-gigs-gig_list.png) | ⚠️ Notes (if applicable) |
